        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'launch_year' } },
              ],
            },
          },
        ],
...
export const LaunchProfileDocument = ({
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown) as DocumentNode<LaunchProfileQuery, LaunchProfileQueryVariables>;
...
export function useLaunchListQuery(
  ...
  return Apollo.useQuery<LaunchListQuery, LaunchListQueryVariables>(
    LaunchListDocument,
    options
  );
}
...
>;
export type LaunchListQueryResult = Apollo.QueryResult<
  LaunchListQuery,
  LaunchListQueryVariables
>;
